...
\par{     \begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, colback=white, breakable, opacityback=0, leftrule=.75mm, arc=.35mm, bottomrule=.15mm, toprule=.15mm, left=2mm, colframe=quarto-callout-note-color-frame]
...
interoception and deception (\citeproc{ref-makowski2023a}{Makowski et
al., 2023}), warranting further investigation.
...
reality (\citeproc{ref-clifton2020}{Clifton, 2020}), are meaningfully
