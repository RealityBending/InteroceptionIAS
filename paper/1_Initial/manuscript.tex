...
\authorsnames{Ana Neves,Magdalena Pfaff,Dominique Makowski}
...
\leftheader{Neves, Pfaff and Makowski}
...
Pfaff}{0009-0006-2386-7936}}\par{\addORCIDlink{Dominique
Makowski}{0000-0001-5375-9967}} 

\par{     \begin{tcolorbox}[enhanced jigsaw, colback=white, breakable, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, arc=.35mm, toprule=.15mm, rightrule=.15mm, opacityback=0, left=2mm, leftrule=.75mm]
...
\citeproc{ref-murphy2019}{Murphy et al., 2019}). The notion that
...
(\citeproc{ref-desmedt2022measures}{Desmedt et al., 2022}). Still, a
...
(\citeproc{ref-murphy2019}{2019}); p.~127{]}. Notably, the only other
validation study to report a 2-factor solution was conducted by Koike
and Nomura (\citeproc{ref-koike2023}{2023}), who performed an
...
(\citeproc{ref-morin2016}{Morin et al., 2015}) have identified different
optimal solutions. Some studies, like Brand et al.
(\citeproc{ref-brand2023}{2023}), reported a 1-factor solution, while
Lin et al. (\citeproc{ref-lin2023}{2023}) and Campos et al.
(\citeproc{ref-campos2021}{2021}) found bifactor solutions - one general
factor and a set of loweroike -level factors (Rodriguez et al.
(\citeproc{ref-rodriguez2016evaluating}{2016})) - to be the best fit.
...
(\citeproc{ref-campos2021}{2021}) suggests that the ``tickle'' item
represents a more specific factor. Interestingly, Lin et al.
(\citeproc{ref-lin2023}{2023}) reported that all items of the IAS
...
Not-Worrying subscales (\citeproc{ref-brand2023}{Brand et al., 2023}).
...
(\citeproc{ref-porges1993body}{1993})) have been mixed: some studies
report small positive correlations (\citeproc{ref-brand2023}{Brand et
al., 2023}; \citeproc{ref-campos2021}{Campos et al., 2021};
...
Questionnaire (FFMQ, Baer et al. (\citeproc{ref-baer2006using}{2006});
Brand et al. (\citeproc{ref-brand2023}{2023}); Koike and Nomura
(\citeproc{ref-koike2023}{2023})), as well as with the nonreactivity and
acting with awareness subscales (\citeproc{ref-koike2023}{Koike \&
Nomura, 2023}). Additionally, the IAS has shown a positive correlation
with the interoceptive awareness subscale of the Eating Disorder
Inventory (\citeproc{ref-lin2023}{Lin et al., 2023}) and a negative
...
(\citeproc{ref-gabriele2022dissociations}{2022})) and the IAS
(\citeproc{ref-koike2023}{Koike \& Nomura, 2023};
