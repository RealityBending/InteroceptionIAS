...
MAIA subscales showed consistent positive associations with IAS: Noticing (β = .259), Attention Regulation (β = .249), Trusting (β = .236), Emotional Awareness (β = .197), Listening (β = .176), and Self-Regulation (β = .189) were significant across IAS pairings and the full scale. Autonomic reactivity (BPQ) was negatively associated (β = −.173, 88% significant), while body awareness was weaker and unreliable (β = .122, 25%). Alexithymia was consistently negative: ICQ (β = −.316), TAS-DIF (β = −.211), TAS-DDF (β = −.150), TAS-EOT (β = −.081, 75%), and BVAQ-Cognitive (β = −.200) were robust. In contrast, BVAQ-Affective showed a weak and inconsistent positive effect (β = .042, 13%).

<!-- Mood questionnaires -->

Depression (BDI: β = −.204) and anxiety (STAI-T: β = −.189) were reliably negative. Additional scales also showed consistent, though weaker, effects: PHQ-15 (β = −.128, 75%), PHQ-4 depression (β = −.094, 75%), PHQ-4 anxiety (β = −.103, 88%), and GAD-7 (β = −.187, 63%). By contrast, PHQ-9 (β = −.619, 25%) and MFQ (β = −.139, 13%) were largely nonsignificant despite negative averages.

<!-- Psychopathology -->

Autistic traits showed the clearest pattern: Imagination (β = −.184, 88%), Low Attentional Switching (β = −.143, 63%), and Lack of Social Skills (β = −.119, 63%) were consistently negative. Among maladaptive traits, only Negative Affect (β = −.111, 63%) showed reliable associations. Schizotypal traits were generally weak, with only No Close Friends (β = −.122, 50%) approaching consistency.

<!-- Personality and beliefs -->

Within the Big Five, Openness (β = .143, 100%), Agreeableness (β = .053, 100%), and Conscientiousness (β = .028, 88%) were consistently positive; other traits were negligible. Conspiracy, world belief, and lying profiles showed no reliable effects, except a small and small and somewhat consistent association with the belief that the world is alive (β = .087, 63%).
