...
Age was positively associated across Ias correlates (mean r = .13), with all correlations significant. Gender showed near-zero effects (mean r = −.06), reaching significance only with the Hungry-Thirsty, Wind-Burp and Urinate-Defecate pairings.

<!-- Interoceptive measures -->
Several MAIA subscales showed consistent positive associations with the IAS: Noticing, Body Listening, Attention Regulation, Trusting, Emotional Awareness, and Self-Regulation (mean r ≈ .18–.26), with effects generally stronger for the full IAS, with the exception of the Body Listenig dimension whose associations were stronger with the Bruise-Blood pairing. The Not Distracting subscale was significantly associated with the whole scale and with three of the seven pairs, namely Hungry–Thirsty, Bruise–Blood sugar, and Muscles–Pain (mean r ≈ .19–.13). By contrast, the Not Worrying subscale was only significant for the full IAS and the Hungry–Thirsty and Urinate–Defecate pairings (mean r ≈ −.009–.108).

Autonomic Reactivity (BPQ; mean r = −.19) was reliably negative across most pairings, while Body Awareness (BPQ; mean r = .12) was weak and only reliable for Bruise-Blood.

In terms of interoceptive deficits, alexithymia measures were consistently negative, with robust effects across both the full IAS and pairings, except for the Affective dimension of the BVAQ, which showed a positive association only with the Bruise–Blood sugar pairing (r = .16). Interoceptive confusion assessed with the ICQ was also consistently negatively associated with all pairings and the full IAS (mean r ≈ −.49–.20).

<!-- Mood and psychopathology -->
Depression (BDI; mean r = −.20) and anxiety (STAI-T; mean r = −.19) were consistently negative across the IAS and most pairings, with Hungry–Thirsty again emerging as a particularly sensitive correlate. Notably, different measures indexing similar constructs showed distinct association patterns: the MFQ was largely nonsignificant despite measuring depressive symptoms comparable to for instance the BDI. Similarly, PHQ-9 followed a weaker and less reliable pattern. Related symptom measures (PHQ-15, PHQ-4, GAD-7) showed weaker but often reliable effects, although some were restricted to specific pairings (e.g., PHQ-15 not significant with Wind–Burp and Breathing–Heart). Notably, most of the mood measures (PHQ-9, BDI, PHQ-4, STAI-T, GAD-7) displayed stronger associations with the Hungry-Thristy pairing than the full IAS.

<!-- Psychopathologies -->
Autistic traits were generally negatively associated with the IAS, with Imagination (mean r = −.18) showing the most consistent effects across pairings, except for Cough–Sneeze. Across subscales, most associations observed for the full IAS were primarily driven by the first three pairings—Hungry–Thirsty, Bruise–Blood sugar, and Muscles–Pain— which showed the strongest and most reliable negative correlations. Beyond these, effects tended to weaken and often became nonsignificant, particularly for Patterns and Numbers, which did not correlate with any IAS correlate, while Borderline Personality only correlated with the Hungry–Thirsty pairing (mean r = −.14).

Schizotypal traits were generally negatively associated with the IAS, with Social Anxiety (mean r = −.11) and No Close Friends (mean r = −.12) showing the most consistent negative effects across pairings. Notably, although some facets did not show consistent associations with the overall IAS, they were significantly related to specific pairings. For example, Unusual Perceptions was associated with the Muscles–Pain and Urinate–Defecate pairings, whereas Eccentric was associated with the Hungry–Thirsty and Urinate–Defecate pairings.

<!-- Personality and beliefs -->
Within the Big Five, Openness (mean r = .14), Agreeableness (mean r = .05), and Conscientiousness (mean r = .03) showed small but consistent positive associations, most reliably captured by the full IAS but also evident in pairings. Honesty–Humility showed a unique negative association with the full IAS scale, largely driven by the Hunger–Thirst and Bruise–Blood sugar item pairings. Similarly, Neuroticism was negatively associated with the full IAS, but this relationship was primarily attributable to the Hunger–Thirst and Wind–Burp pairings, with the strongest correlation observed for Hunger–Thirst (r = −.23).

Primal world beliefs measures were largely null, but certain beliefs showed small yet consistent associations with specific IAS item pairings. Belief in a comprehensible world (“Understandable”) correlated positively with most pairings except Urinate–Defecate and Cough–Sneeze, while beliefs that the world is “Alive” and “Hierarchical” were associated with the full IAS and Hunger–Thirsty, and “Good” was uniquely linked to Muscles–Pain (mean r = .09). For the Lying Profile, only Lying Contextuality showed a notable negative association with the Bruise–Blood sugar pairing (r = −.12).

Conspiracy Beliefs showed selective associations, with Global Conspiracies linked to the full IAS and several pairings (Original, Hunger–Thirsty, Cough–Sneeze, Urinate–Defecate; mean r = .103), Personal Wellbeing to the full IAS and Hunger–Thirsty (mean r = .086), and Information Control to Cough–Sneeze (mean r =  .06). 

<!-- Differences between the full IAS and item pairings -->
Overall, the full IAS yielded the largest number of significant associations (29), but these were often driven by specific item pairings rather than reflecting uniform effects across the scale. The Hungry–Thirsty (17) and Bruise–Blood sugar (10) pairings consistently produced equally strong or stronger effects, particularly for interoceptive, mood, and psychopathology measures. In contrast, other pairings (e.g., Cough–Sneeze, Wind–Burp, Urinate–Defecate) contributed little unique variance and rarely produced meaningful associations.

## Discussion

<!-- Aim and conceptual focus -->
Study 2 examined the dispositional correlates of the IAS and evaluated whether the refined 14-item version offers practical advantages over the original 21-item scale. The findings clarify the conceptual boundaries of self-reported interoceptive accuracy across psychological domains and highlight the domain-specific nature of these associations.

<!-- Interoception and correlates - item specific -->
The IAS correlated robustly with other self-report interoceptive measures, particularly MAIA facets reflecting awareness, regulation, and trust in bodily signals. These associations were stronger with monitoring of autonomic reactivity (BPQ) than with general body awareness (BPQ) replicating previosu findings [@brand2023; @campos2021; @todd2022].  

Across mood and interoceptive measures, most item pairings showed at least moderate correlations, suggesting that the IAS shares variance with affective and bodily awareness constructs. In contrast, associations with psychopathology were more selective: significant correlations were mainly observed for visceral pairings such as Hunger–Thirsty and Bruise–Blood sugar, while other pairings were weak or nonsignificant. This pattern points to variation in how different interoceptive domains relate to affective and clinical traits [@murphy2019; @koike2023].

<!-- Personality, worldview, and boundaries of interoception -->
Associations with personality traits showed similar pattern. Effects for the full IAS often reflected contributions from specific pairings: Breathing–Heart correlated most strongly with Openness; Bruise–Blood sugar and Muscles–Pain with Extraversion; and Hunger–Thirsty with Neuroticism. Additionally, the negative correlation with Honesty–Humility in the full scale was mainly attributable to the Hunger–Thirsty and Bruise–Blood sugar pairings. These findings indicate that the strength of associations between interoceptive self-report and personality traits depends on the bodily domain represented by the items.

Correlations with belief systems were small and inconsistent. Some primal world beliefs (e.g., perceiving the world as alive or comprehensible) showed weak positive associations with the full IAS and with certain pairings [@simkute2025interoception; @haustein2024interoception; @gabriele2022dissociations]. These associations were not uniform across items, again reflecting variability in how interoceptive self-reports relate to broader cognitive or worldview constructs.

Correlations with broader belief systems, including conspiracy beliefs and primal world beliefs, were generally small and inconsistent. Some weak positive associations were observed between the IAS and beliefs that the world is comprehensible or alive, and with certain conspiracy belief dimensions, particularly Global Conspiracies and Personal Wellbeing. These effects were largely limited to specific pairings, most notably Hunger–Thirsty and Bruise–Blood sugar, suggesting that any links between interoceptive self-report and belief systems are modest and not uniform across bodily domains.

<!-- Contextual sensitivity and scale refinement -->
Certain item pairings, notably Hunger–Thirsty and Bruise–Blood sugar, correlated with mood and interoceptive measures as strongly as, or more strongly than, the full IAS. These pairings accounted for many of the significant relationships observed across variables, whereas others (e.g., Cough–Sneeze, Wind–Burp) showed few consistent effects.  

The refined 14-item IAS performed comparably to the original 21-item version, maintaining similar patterns of association while reducing item redundancy. This supports the practical utility of the shortened version, which captures the same correlational structure with improved efficiency and interpretability.

<!-- Summary -->
Overall, correlations between the IAS and external measures were not uniform but varied across bodily domains. The results indicate that some interoceptive item pairings, especially those representing visceral sensations, show stronger and more consistent relationships with interoceptive, affective, and personality measures. The refined 14-item IAS retains these patterns while providing a more concise and interpretable assessment of self-reported interoceptive accuracy.
...
<!-- Study 1 findings -->
Study 1 demonstrated that the IAS is best conceptualised as comprising tightly coupled item pairs, reflecting discrete bodily domains such as visceral sensations, musculoskeletal cues, and expulsion phenomena. The pairs emerged after several items (e.g., Tickle, Taste, Affective Touch) were removed due to their instability, redundancy, or poor associations with the other items. The resulting 14-item IAS retained the psychometric integrity of the original scale while improving interpretability and efficiency.

A short version of the IAS has been proposed before.  @lin2023 suggested a 12-item version by removing items with local dependency, high difficulty, and/or low discrimination. Their parallel analysis suggested unidimensionality, although parallel analysis is known to underestimate factor numbers in multidimensional data [@golino2017exploratory; @markos2024dimensionality]. 

In contrast, our study applied multiple methods including EGA, FA, and HCA yet the same pairs consistently emerged across datasets and demonstrated superior fit compared to alternative models, which challenges the assumption of unidimensionality of the IAS [@murphy2019; @brand2023]. Although the short version of the IAS by  @lin2023 favoured a one-factor solution, their 12-item IAS was derived by removing locally dependent items identified through Item Response Theory (IRT). 

We found that these locally dependent items can instead be interpreted as meaningful pairs (e.g., Heart–Breath), reflecting distinct bodily domains. Because IRT assumes unidimensionality [@nguyen2014introduction], it may have treated these natural item clusters as statistical artefacts rather than as theoretically relevant structures within interoceptive accuracy.
