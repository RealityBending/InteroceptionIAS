...
In order to obtain a comprehensive view, we will examine the factor structure of the IAS using two different approaches, namely Exploratory Graph Analysis (EGA) and traditional exploratory and confirmatory Factor Analysis (EFA/CFA).
