...
![Figure 1. Different ways in which interoception can be measured.](figures/measuring_interoception.png) <!-- TODO: replace with a code chunk that allows for legend -->
...
![Figure 1. Different ways in which interoception can be measured.](figures/table1.png){width="580"}
