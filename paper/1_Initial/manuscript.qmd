...
<!-- Psychopathologies -->
Autistic traits were generally negatively associated with the IAS, with Imagination (mean r = −.18) showing the most consistent effects across pairings, except for Cough–Sneeze. Most of the significant associations between the full IAS and autistic traits were driven by the first three pairings—Hungry–Thirsty, Bruise–Blood sugar, and Muscles–Pain—which showed the strongest and most reliable negative correlations. Beyond these, effects tended to weaken and often became nonsignificant, particularly for Patterns and Numbers, which did not correlate with any IAS correlate. Borderline Personality was only significantly associated with the Hungry–Thirsty pairing (mean r = −.14). 

Lastly, schizotypal traits (SPQ) were also generally negative and non-significant, but several significant associations with the full IAS appeared to be driven by particular pairings. 
...
At the same time, these associations were context-dependent: not all item pairings or bodily domains related equally to mood or somatic symptoms [@murphy2019; @koike2023]. Emerging evidence suggests that interoceptive abilities (e.g., sensitivity, precision and metacognitive insight) may not uniformly predict mental health outcomes and may depend on measurement approach or sample characteristics [@@banellis2025interoceptive].
