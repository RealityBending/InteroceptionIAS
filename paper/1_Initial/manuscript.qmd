...
One striking example concerns the assessment of "interoceptive sensibility", defined as the self-reported tendency to focus on and detect internal sensations [@garfinkel2015knowing], or more narrowly as the subjective ability to focus on interoceptive signals [@khalsa2018interoception]. **TODO: ANA check if the definitions are correct**.
A recent systematic review suggested that various questionnaires [**WHICH ONES**] designed to assess this dimension actually measure distinct constructs, leading researchers to mistakenly treating them as equivalent measures [@desmedt2022measures].
