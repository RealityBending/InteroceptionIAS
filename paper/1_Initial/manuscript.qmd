...
**note to dom review this. 1. yes I think they are general interoceptive signals (I added the items that loaded to both factors for Murphy's and Koike's validation) 2. Do we want to add that lin created a short verison of the scale? 3. Yes kioke  did named their factors**
