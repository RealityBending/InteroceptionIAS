...
table <- data.frame(
  ...
  N = c('', 451, 375, 814, 515, 802, 96, 619,'', 522, 1993, 802,'', 1166, 500, 21843, 485, 251, "\\textbf{31317}"),
...
knitr::kable(table, format = "latex", booktabs = TRUE, longtable = TRUE, col.names = stringr::str_replace(names(table), "Female_Percentage", "Female %")) |> 
