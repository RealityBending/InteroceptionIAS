...
Because perceived accuracy in one system can generalize to conceptually or functionally related sensations, two-item clusters may overemphasize these links and fail to capture variability across unrelated domains, while overall scores risk obscuring meaningful relationships.This limitation is especially important given that researchers may assume interoceptive abilities generalize across bodily domains, when in fact they do not. Building on @desmedt2022measures’ observation of a “jingle fallacy” in using self-reported interoceptive measures, the present findings extend this caution by highlighting that assuming beliefs replicate across domains constitutes a similar jingle fallacy. 

Additionally, items lack contextual specification (e.g., physiological vs. affective triggers). For instance, a racing heart could signal anxiety or exercise; without context, it is unclear which state participants referenced from. Such ambiguities may constrain ecological validity and contribute to variability across studies [@vlemincx2023novel]. Expanding item content and adopting context-specific phrasing will be important for future measurement development to more comprehensively capture interoceptive beliefs.
