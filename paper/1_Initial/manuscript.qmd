...
<!-- Item Structure, Redundancy, and Scale Refinement -->

Study 1 demonstrated that the IAS is best conceptualized as clusters of tightly coupled item pairs, reflecting discrete bodily domains such as visceral sensations, musculoskeletal cues, and expulsion phenomena. Several items (e.g., Tickle, Taste, Affective Touch) were unstable, redundant, or poorly associated with broader interoceptive tendencies, justifying their removal. The resulting 14-item refined IAS retained the psychometric integrity of the original scale while improving interpretability and efficiency. Crucially, the item clusters reveal that the IAS does not capture a unitary construct of interoception. Instead, interoceptive self-report appears domain-specific, with meaningful differences across bodily modalities. This challenges the assumption of unidimensionality [@murphy2019; @lin2023] and resonates with theoretical perspectives that describe interoception as a multimodal, context-sensitive process rather than a singular capacity [@khalsa2018interoception].

<!-- Context-Specific Sensitivity of Interoception -->

Study 2 reinforced this domain-specific view. Certain item pairings, particularly Hunger–Thirst and Bruise–Blood sugar, consistently predicted mood and interoceptive outcomes as well as, or better than, the full scale. These findings indicate that interoceptive self-report is most informative when tied to ecologically meaningful bodily signals, echoing prior suggestions that physiological context are important in the measurement of interoception [@vlemincx2023novel]. At the same time, other pairings (e.g., cough–sneeze, wind–burp) provided little predictive value. Taken together with Study 1, this suggests that the strength of interoceptive reporting lies not in broad aggregation but in the careful targeting of specific bodily domains.

<!-- Correlates Across Psychological Domains -->

The dispositional correlates of the IAS provide important conceptual boundaries for the construct. Interoceptive accuracy, as assessed by the IAS, was robustly associated with mood-related outcomes, particularly depression and anxiety, underscoring its relevance for affective regulation and bodily state monitoring [@brand2023; @lin2023]. In contrast, associations with personality traits and higher-order beliefs were modest: small positive correlations emerged with Openness and Agreeableness, and weak associations with primal world beliefs. Consistent with recent work linking interoceptive self-report to personality dispositions [@simkute2025interoception; @haustein2024interoception], these results suggest that interoceptive accuracy primarily operates at the level of bodily self-perception, exerting modest influence on broader dispositional tendencies.

At the same time, recent studies have reported null or inconsistent associations between interoceptive abilities and mental health symptomatology, suggesting that such links may not generalize across all interoceptive domains or measurement approaches [**ref pre-print?**]. A potential key reason for these discrepancies is the lack of a consistent theoretical framework for interoception, as dimensions are neither defined nor captured equally across questionnaires and experimental tasks [@Desmedt2023accuracy].

<!-- IAS limitations and potential improvements -->

The structural and correlational findings converge to highlight both limitations of the IAS and opportunities for scale refinement. Although the 14-item refined version improves interpretability and efficiency, the scale continues to underrepresent key interoceptive modalities such as cardiac, respiratory, and nuanced somatosensory signals (i.e., only one item each), reducing variability and potentially obscuring meaningful individual differences. Nevertheless, analogue-style items and item pairings offer clear advantages: they capture greater response variability, allow more precise differentiation among individuals, and provide efficient, domain-specific indicators that often outperform global scores in predictive value. Building on these insights, a next-generation interoception scale could balance breadth (multiple items per modality) with depth (domain-specific subscales), retain the benefits of analogue or wider rating ranges (e.g., 1–7 instead of 1–5), and optimize coverage across physiologically and psychologically relevant bodily domains. Such a scale would improve the interpretability, sensitivity, and practical utility of interoceptive self-report measures, ultimately allowing for a more nuanced mapping of interoceptive abilities to affective, cognitive, and health-related outcomes.

<!-- Conclusion -->

Taken together, these studies advance understanding of the IAS and interoceptive self-report more broadly. The refined 14-item IAS provides a more efficient and interpretable measure, capturing domain-specific interoceptive signals that are differentially associated with psychological outcomes. Consistent associations with mood, alongside modest links to personality and beliefs, indicate that the IAS reflects adaptive, context-sensitive aspects of bodily self-perception rather than broad dispositional traits. At the same time, current findings highlight limitations in modality coverage and item specificity, suggesting that future scale development should incorporate multimodal, context-sensitive, and continuous analogue ratings or wider discrete scales, to better capture the richness of interoceptive processes and clarify their role in affective, cognitive, and health-related outcomes [@desmedt2022measures; @vlemincx2023novel].
