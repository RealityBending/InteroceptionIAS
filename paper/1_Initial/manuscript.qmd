...
abstract: | 
  Various questionnaires assessing interoceptive sensibility (i.e., the tendency to focus on and detect   internal bodily sensations) have shown low correlations, highlighting the need for greater conceptual clarity (Desmedt et al., 2022). The Interoceptive Accuracy Scale (IAS) is a recently developed measure of subjective interoceptive accuracy, but studies have reported inconsistent factor structures. This paper, therefore, aimed to (1) clarify the IAS structure using a mega-analytic approach and (2) examine its construct validity. In Study 1 (N = 33,526 across 17 open-access datasets), three analytic approaches were applied: exploratory and confirmatory factor analysis, hierarchical clustering, and exploratory graph analysis. Analyses identified redundant or unstable items, resulting in a refined 14-item IAS comprising seven item pairs (e.g., Hunger–Thirst, Urinate–Defecate, Cough–Sneeze). Study 2 examined associations between the IAS and measures of interoception, mood, anxiety, psychopathology, personality, and belief-related constructs. The IAS positively correlated with most MAIA facets (except Not-Distracting and Not-Worrying) and BPQ-Body Awareness, and negatively with BPQ Autonomic Reactivity, alexithymia, and interoceptive confusion. Mood showed small-to-moderate negative associations, while associations with psychopathology were selective, primarily observed for visceral item pairings. Belief-related associations were generally small. The 14-item IAS performed comparably to the original 21-item version, but item-pairing improved interpretability and highlighted domain-specific patterns. Overall, self-perceived interoceptive accuracy appears to be a differentiated construct across bodily systems. Future research should expand item content and adopt context-specific phrasing to capture interoceptive beliefs more comprehensively.
#   **Significance Statement**. TODO.
keywords: "Interoception questionnaires, interoception accuracy scale, mega-analysis, IAS factor-structure, IAS Validation, MAIA, BPQ, domain-specific associations"
floatsintext: true
numbered-lines: true
