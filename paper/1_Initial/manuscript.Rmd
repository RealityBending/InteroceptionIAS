...
Interoception - definition - is a trending topic, becoming a central mechanism of embodied cognition, and showing a key contribution to higher order processes such as .... 
...
One of the most recent scale developped is the IAS, which is interesting because... It has *n* items, such as ...
However, the study analysis did not go in depth in the analysis of the factor structure, focusing instead on ....


The purpose of this work is to re-analyze the factor structure of the scale using complementary statistical approaches, a further extend its validation by comparing a revised version with one of the most popular questionnaire of interoception, the MAIA-2 (*ref*), as well as other relevant indices (such as psychopathological traits).
...
One of the most intriguing new results was the reilationship between interoceptive abilities and several specific primal world beliefs.
