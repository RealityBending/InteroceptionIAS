...
Study 1 systematically evaluated IAS structure using a mega-analytic, multi-method approach (EFA, HCA, EGA). Previous research has highlighted inconsistencies in optimal factor structure [e.g., unidimensional, bifactor, and two-factor solutions; @brand2023; @campos2021; @lin2023; @murphy2019; @koike2023] and raised concerns about specific items (e.g., low discrimination, local dependencies, items less accessible to interoception). To address these issues we combined 17 datasets with over 33,000 participants, to provide the most comprehensive analysis of IAS structure to date, across both combined and individual datasets.
...
Although widely adopted, evidence on the IAS's associations with personality traits, affective dispositions, and related constructs remains scattered and inconsistent [@murphy2019; @brand2023; @lin2023; @todd2022]. Therefore, study 2 provides a robust overview of IAS dispositional correlates by combining a large number of datasets containing the IAS, other interoception measures, and dispositional variables. We also assess whether the refined 14-item IAS yields clearer and more reliable external associations than the original 21-item unidimensional version.
...
<!-- Aims -->
Across two studies combining 17 datasets and over 33,000 participants, we provide the most comprehensive evaluation of the IAS to date, examining both its structure (Study 1) and dispositional correlates (Study 2), with implications for its conceptual interpretation and use in future research.
...
<!-- Conclusion -->
In summary, the IAS is a solid measure of self-reported interoceptive accuracy with expected patterns of external associations. However, our findings challenge its structure and scoring, suggesting a refined 14-item version with seven domain-specific item pairs better captures interpretable and ecologically valid interoceptive beliefs. More broadly, our results highlight the value of conceptualising interoceptive processes as domain-specific rather than unidimensional, and underscore the need for targeted scale refinement and development of novel, context-sensitive, multidimensional interoception measures.
