...
rez_ega <- make_ega(data3, cols = c(
  "C1" = colors[["Heart"]], "C2" = colors[["Hungry"]], "C3" = colors[["Defecate"]], "C4" = colors[["Muscles"]], 
  "C5" = colors[["Cough"]], "C6" = colors[["Wind"]], "C7" = colors[["Bruise"]], "C8" = colors[["Blood Sugar"]]))
rez_efa <- make_efa(data3, n = 3, cols = c("F1" = colors[["Sneeze"]], "F2" = colors[["Hungry"]], 
...
rez_ega <- make_ega(data5, cols = c(
  "C1" = colors[["Heart"]], "C2" = colors[["Hungry"]], "C3" = colors[["Defecate"]], "C4" = colors[["Muscles"]], 
  "C5" = colors[["Cough"]], "C6" = colors[["Wind"]], "C7" = colors[["Bruise"]], "C8" = colors[["Blood Sugar"]]))
rez_efa <- make_efa(data5, n = 8, cols = c("F1" = colors[["Wind"]], "F2" = colors[["Itch"]], 
                                            "F3" = colors[["Breathing"]], "F4" = colors[["Urinate"]], "F5" = colors[["Burp"]], "F6" = colors[["Taste"]], "F7" = colors[["Heart"]], "F8" = colors[["Vomit"]]))
