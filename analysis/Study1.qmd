...
- Petzke et al 2024
- STAI - is the stai sf with 6 items (we use stait-trait)

```{r}

df17 <- haven::read_sav("../data/Petzke2024/ETUDE1_main study.sav") |>
  select(id, age_to_be_completed_that_year, Gender, starts_with("IA0"), PHQ_15_total, DIF_total, DDF_total, EOT_total, PHQ_4_total, BPQ_total, STAI_total) |>
...
df17$PHQ4_Depression <- (df13$PHQ4_Depression_4 + df13$PHQ4_Depression_3)/2
df13$PHQ4_Anxiety <- (df13$PHQ4_Anxiety_2 + df13$PHQ4_Anxiety_1)/2
