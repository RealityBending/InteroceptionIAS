...
table <- data.frame(
   Sample = c('Murphy et al., (2020)', '', '', 'Gaggero et al., (2021)', 'Campos et al., (2022)', 'Todd et al., (2022)', 'Arslanova et al., (2022)', 'Brand et al., (2022)', 'Brand et al., (2023)', '', '', '', 'Lin et al., (2023)', '', '', 'VonMohr et al., (2023)', 'Makowski et al., (2023a)', 'Makowski et al., (2023b)', 'Makowski et al., (2023c)', 'Poerio et al., (2024)', 'Poerio et al., unpublished', 'Total'),
...
p1 <- p1_data |>
  ...
  labs(x = "Response", y = "Distribution", color = "Item", linetype = "Item") +
  facet_wrap(~Sample, scales = "free_y", nrow = 3)

ggsave("figures/Figure1.png", p1, width=12, height=7, dpi=300, bg="white")
p1
```
...
```{r}
cols_to_remove <- c("Temp", "Vomit", "Affective_touch", "Sex_arousal", "Taste", "Tickle", "Bloo")
```
...
efa5 <- parameters::factor_analysis(data_all, n = 3, rotation = "oblimin", sort = TRUE)
plot(efa5)
...
efa4 <- parameters::factor_analysis(data1a, n = 3, rotation = "oblimin", sort = TRUE)
plot(efa4)
...
efa4 <- parameters::factor_analysis(data1b, n = 3, rotation = "oblimin", sort = TRUE)
plot(efa4)
...
efa4 <- parameters::factor_analysis(data2, n = 3, rotation = "oblimin", sort = TRUE)
plot(efa4)
...
efa4 <- parameters::factor_analysis(data3, n = 3, rotation = "oblimin", sort = TRUE)
plot(efa4)
...
efa4 <- parameters::factor_analysis(data4, n = 3, rotation = "oblimin", sort = TRUE)
plot(efa4)
...
efa4 <- parameters::factor_analysis(data5, n = 3, rotation = "oblimin", sort = TRUE)
plot(efa4)
...
efa4 <- parameters::factor_analysis(data6, n = 3, rotation = "oblimin", sort = TRUE)
plot(efa4)
...
efa4 <- parameters::factor_analysis(data7a, n = 3, rotation = "oblimin", sort = TRUE)
plot(efa4)
...
efa4 <- parameters::factor_analysis(data7b, n = 3, rotation = "oblimin", sort = TRUE)
plot(efa4)
...
efa4 <- parameters::factor_analysis(data7c, n = 3, rotation = "oblimin", sort = TRUE)
plot(efa4)
...
efa4 <- parameters::factor_analysis(data8a, n = 3, rotation = "oblimin", sort = TRUE)
plot(efa4)
...
efa4 <- parameters::factor_analysis(data8b, n = 3, rotation = "oblimin", sort = TRUE)
plot(efa4)
...
efa4 <- parameters::factor_analysis(data9, n = 3, rotation = "oblimin", sort = TRUE)
plot(efa4)
...
efa4 <- parameters::factor_analysis(data10a, n = 3, rotation = "oblimin", sort = TRUE)
plot(efa4)
...
efa4 <- parameters::factor_analysis(data10b, n = 3, rotation = "oblimin", sort = TRUE)
plot(efa4)
...
efa4 <- parameters::factor_analysis(data10c, n = 3, rotation = "oblimin", sort = TRUE)
plot(efa4)
...
efa4 <- parameters::factor_analysis(data11a, n = 3, rotation = "oblimin", sort = TRUE)
plot(efa4)
...
efa4 <- parameters::factor_analysis(data11b, n = 3, rotation = "oblimin", sort = TRUE)
plot(efa4)
