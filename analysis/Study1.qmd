...
df2 <- data |> 
  ...
  rename(
    ...
    BPQ_BodyAwareness = BPQ_A, BPQ_AutonomicReactivity = BPQ_R)
rm(data)
```
...
df4$BPQ_BodyAwareness <- rowMeans(select(df4, starts_with("BPQ")), na.rm = TRUE)
```
...
df8a$BPQ_BodyAwareness <- rowMeans(select(df8a, starts_with("BPQ")), na.rm = TRUE)
...
df9 <- df9 |>
  ...
  mutate(
    BFI_NEUROTICISM = (BFI_1 + BFI_2 + BFI_3)/3,
    BFI_AGREEABLENESS = (BFI_10R + BFI_11 + BFI_12)/3,
    BFI_EXTROVERSION = (BFI_4 + BFI_5 + BFI_6),
    BFI_CONSCIENTIOUSNESS = (BFI_13 + BFI_14 + BFI_15R)/3,
    BFI_OPENNESS = (BFI_7 + BFI_8 + BFI_9)/3
    )
```
...
df11 <- mutate(df11, across(starts_with("MAIA_"), \(x) datawizard::rescale(x, to = c(0, 5)))) 
...
df16 <- read.csv("../data/Scharte2025/data_IAS_rs.csv") |>
  rename(Age= age, Gender = gender_identity,
...
rez_ega <- make_ega(data1af, cols = c(
  "C1" = colors[["Heart"]], "C2" = colors[["Hungry"]], "C3" = colors[["Defecate"]], "C4" = colors[["Muscles"]], 
  "C5" = colors[["Cough"]], "C6" = colors[["Wind"]], "C7" = colors[["Bruise"]], "C8" = colors[["Blood Sugar"]]))
rez_efa <- make_efa(data1af, n = 3, cols = c("F1" = colors[["Wind"]], "F2" = colors[["Defecate"]], 
                                            "F3" = colors[["Heart"]]))
...
rez_ega <- make_ega(data5, cols = c(
  "C1" = colors[["Heart"]], "C2" = colors[["Hungry"]], "C3" = colors[["Defecate"]], "C4" = colors[["Muscles"]], 
  "C5" = colors[["Cough"]], "C6" = colors[["Wind"]], "C7" = colors[["Bruise"]], "C8" = colors[["Blood Sugar"]]))
rez_efa <- make_efa(data5, n = 4, cols = c("F1" = colors[["Wind"]], "F2" = colors[["Itch"]], 
...
#   "C1" = colors[["Heart"]], "C2" = colors[["Hungry"]], "C3" = colors[["Defecate"]], "C4" = colors[["Muscles"]], 
#   "C5" = colors[["Cough"]], "C6" = colors[["Wind"]], "C7" = colors[["Bruise"]], "C8" = colors[["Blood Sugar"]]))
rez_efa <- make_efa(data5f, n = 5, cols = c("F1" = colors[["Wind"]], "F2" = colors[["Defecate"]], 
                                            "F3" = colors[["Heart"]], "F4" = colors[["Itch"]],
                                            "F5" = colors[["Urinate"]]))
...
rez_ega <- make_ega(data12, cols = c(
  "C1" = colors[["Heart"]], "C2" = colors[["Hungry"]], "C3" = colors[["Defecate"]], "C4" = colors[["Muscles"]], 
  "C5" = colors[["Cough"]], "C6" = colors[["Wind"]], "C7" = colors[["Bruise"]], "C8" = colors[["Blood Sugar"]]))
rez_efa <- make_efa(data12, n = 2, cols = c("F1" = colors[["Wind"]], "F2" = colors[["Defecate"]], 
                                            "F3" = colors[["Heart"]], "F4" = colors[["Itch"]]))
...
rez_ega <- make_ega(data8af, cols = c(
  "C1" = colors[["Heart"]], "C2" = colors[["Hungry"]], "C3" = colors[["Defecate"]], "C4" = colors[["Muscles"]], 
  "C5" = colors[["Cough"]], "C6" = colors[["Wind"]], "C7" = colors[["Bruise"]], "C8" = colors[["Blood Sugar"]]))
rez_efa <- make_efa(data12f, n = 5, cols = c("F1" = colors[["Wind"]], "F2" = colors[["Defecate"]], 
                                             "F3" = colors[["Heart"]], "F4" = colors[["Itch"]]))
...
rez_ega <- make_ega(data14, cols = c(
  "C1" = colors[["Heart"]], "C2" = colors[["Hungry"]], "C3" = colors[["Defecate"]], "C4" = colors[["Muscles"]], 
  "C5" = colors[["Cough"]], "C6" = colors[["Wind"]], "C7" = colors[["Bruise"]], "C8" = colors[["Blood Sugar"]]))
rez_efa <- make_efa(data14, n = 3, cols = c("F1" = colors[["Wind"]], "F2" = colors[["Defecate"]], 
                                            "F3" = colors[["Heart"]], "F4" = colors[["Itch"]]))
...
rez_ega <- make_ega(data15, cols = c(
  "C1" = colors[["Heart"]], "C2" = colors[["Hungry"]], "C3" = colors[["Defecate"]], "C4" = colors[["Muscles"]], 
  "C5" = colors[["Cough"]], "C6" = colors[["Wind"]], "C7" = colors[["Bruise"]], "C8" = colors[["Blood Sugar"]]))
rez_efa <- make_efa(data15, n = 3, cols = c("F1" = colors[["Wind"]], "F2" = colors[["Defecate"]], 
                                            "F3" = colors[["Heart"]], "F4" = colors[["Itch"]]))
