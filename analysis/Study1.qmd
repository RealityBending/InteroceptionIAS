...
df17 <- haven::read_sav("../data/Petzke2024/ETUDE1_main study.sav") |>
  mutate_all(as.numeric) |>
  select(id, age_to_be_completed_that_year, Gender, starts_with(c("IA0", "PH01")), PHQ_15_total, DIF_total, DDF_total, EOT_total, PHQ_4_total, BPQ_total) |>
...
df17$PHQ4_Depression <- (df17$PH01_01 + df17$PH01_02)/2
df17$PHQ4_Anxiety <- (df17$PH01_03 + df17$PH01_04)/2
...
- **Sample 17 **: Data from [Petzke's](https://osf.io/seru4) study, downloaded from OSF, included `r report::report_participants(df17, age = "Age", gender = "Gender")`. 
...
scores <- list(
  ...
  sample17 = add_empirical(data17, "Sample 16")
)
