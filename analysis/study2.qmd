...
data <- pool_coef(with = "Gender", component = "Demographic", category = "Demographics", name = "Gender (Female - Male)")
```
...
# check_ranges("Age")
data <- rbind(data, pool_coef(with = "Age", component = "Demographic", category = "Demographics", unequalrange=TRUE))
```
...
data <- rbind(
  data,
  pool_coef(with = "Neuroticism", component = "Personality", category = "Personality", name = "Neuroticism", unequalrange=TRUE),
  pool_coef(with = "Agreeableness", component="Personality", category = "Personality", name = "Agreeableness",unequalrange=TRUE),
  pool_coef(with = "Conscientiousness", component="Personality", category = "Personality", name = "Conscientiousness",unequalrange=TRUE), 
  pool_coef(with = "Openness", component="Personality", category = "Personality", name = "Openness",unequalrange=TRUE),
  pool_coef(with = "Extraversion", component="Personality", category = "Personality", name = "Extraversion", unequalrange=TRUE),
  pool_coef(with = "HonestyHumility", component="Personality", category = "Personality", name = "Honesty-Humility", unequalrange=TRUE)
)
```
...
data <- rbind(
  ...
  pool_coef(with = "PHQ4_Depression", component="Depression", category = "Mood", name = "Depression - PHQ-4", unequalrange=TRUE),
...
data <- rbind(
  ...
  pool_coef(with = "PHQ4_Anxiety", component="Anxiety", category = "Mood", name = "Anxiety - PHQ-4",  unequalrange=TRUE),
...
data <- rbind(
  data,
  pool_coef(with = "BPD", component="Maladaptive", category = "Psychopathology and Neurodevelopmental Traits", name = "Boderline Personality")
)
```
...
data <- rbind(
  data,
  pool_coef(with = "PID5_Antagonism", component="Maladaptive", category = "Psychopathology and Neurodevelopmental Traits", name = "Antagonism - PID-5"),
  pool_coef(with = "PID5_Detachment", component="Maladaptive", category = "Psychopathology and Neurodevelopmental Traits", name = "Detachment - PID-5"), 
  pool_coef(with = "PID5_Disinhibition", component="Maladaptive", category = "Psychopathology and Neurodevelopmental Traits", name = "Disinhibition - PID-5"),
  pool_coef(with = "PID5_NegativeAffect", component="Maladaptive", category = "Psychopathology and Neurodevelopmental Traits", name = "Negative Affect - PID-5"),
  pool_coef(with = "PID5_Psychoticism", component="Maladaptive", category = "Psychopathology and Neurodevelopmental Traits", name = "Psychoticism - PID-5")
)
```
...
data <- rbind(
  data,
  pool_coef(with = "SPQ_ConstrictedAffect", component="Schizotypic", category = "Psychopathology and Neurodevelopmental Traits", name = "Constricted Affect - SPQ"),
  pool_coef(with = "SPQ_Eccentric", component="Schizotypic", category = "Psychopathology and Neurodevelopmental Traits", name = "Eccentric - SPQ"),
  pool_coef(with = "SPQ_MagicalThinking", component="Schizotypic", category = "Psychopathology and Neurodevelopmental Traits", name = "Magical Thinking - SPQ"),
  pool_coef(with = "SPQ_NoCloseFriends", component="Schizotypic", category = "Psychopathology and Neurodevelopmental Traits", name = "No Close Friends - SPQ"),
  pool_coef(with = "SPQ_OddSpeech", component="Schizotypic", category = "Psychopathology and Neurodevelopmental Traits", name = "Odd Speech - SPQ"),
  pool_coef(with = "SPQ_Reference", component="Schizotypic", category = "Psychopathology and Neurodevelopmental Traits", name = "Reference - SPQ"),
  pool_coef(with = "SPQ_SocialAnxiety", component="Schizotypic", category = "Psychopathology and Neurodevelopmental Traits", name = "Social Anxiety - SPQ"),
  pool_coef(with = "SPQ_Suspiciousness", component="Schizotypic", category = "Psychopathology and Neurodevelopmental Traits", name = "Suspiciousness - SPQ"),
  pool_coef(with = "SPQ_UnusualPerceptions", component="Schizotypic", category = "Psychopathology and Neurodevelopmental Traits", name = "Unusual Perceptions - SPQ")
)
```
...
data <- rbind(
  data,
  pool_coef(with = "ASQ_Imagination", component="Autistic", category = "Psychopathology and Neurodevelopmental Traits", name = "Imagination - ASQ"),
  pool_coef(with = "ASQ_LackSocialSkills", component="Autistic", category = "Psychopathology and Neurodevelopmental Traits", name = "Lack of Social Skills - ASQ"), 
  pool_coef(with = "ASQ_LowAttentionalSwitching", component="Autistic", category = "Psychopathology and Neurodevelopmental Traits", name = "Low Attentional Switching - ASQ"),
  pool_coef(with = "ASQ_Patterns", component="Autistic", category = "Psychopathology and Neurodevelopmental Traits", name = "Patterns and Numbers - ASQ"),
  pool_coef(with = "ASQ_Routine", component="Autistic", category = "Psychopathology and Neurodevelopmental Traits", name = "Routines - ASQ")
)
```
  ...
  mutate(sig = ifelse(p < .01, "p < .01", ifelse(p < .001, "p < .001", "N.S.")),
      ...
      "Demo" = "Demographics"),
         Category = fct_relevel(
           Category, "Demo", "Interoception", "Mood", "Psychopathology and Neurodevelopmental Traits", "Personality", "Beliefs"),
         Component = fct_relevel(Component, "Demographic", "Interoception", "MAIA", "Anxiety", "Depression", "Schizotypic", "Autistic", "Maladaptive", "Personality", "World Beliefs", "Conspiracy Beliefs", "Lying Profile")) |> 
  group_by(Component) |> 
...
p
ggsave("figures/Figure3.png", p, width=25*0.55, height=38*0.4, dpi=300, bg="white")
```
