...
# data <- rbind(
#   data,
#   pool_coef(with = "PI_Alive", component="World Beliefs", name = "Alive"),
#   pool_coef(with = "PI_Changing", component="World Beliefs", name = "Changing"),
#   pool_coef(with = "PI_Enticing", component="World Beliefs", name = "Enticing"),
#   pool_coef(with = "PI_Good", component="World Beliefs", name = "Good"),
#   pool_coef(with = "PI_Hierarchical", component="World Beliefs", name = "Hierarchical"),
#   pool_coef(with = "PI_Safe", component="World Beliefs", name = "Safe"),
#   pool_coef(with = "PI_Understandable", component="World Beliefs", name = "Understandable"),
# )
```
