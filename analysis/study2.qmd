...
data <- pool_coef(with = "Gender", component = "Demographic", category = "Demographic", name = "Gender (Female - Male)")
```
...
# check_ranges("Age")
data <- rbind(data, pool_coef(with = "Age", component = "Demographic", category = "Demographic", unequalrange=TRUE))
```
  ...
  mutate(sig = ifelse(p < .01, "p < .01", ifelse(p < .001, "p < .001", "N.S.")),
      ...
      "Psychopathology and Neurodevelopmental Traits"
         ...
         Category = fct_relevel(
           Category, "Demographics", "Interoception", "Mood", "Psychopathology and Neurodevelopmental Traits", "Personality", "Beliefs"),
