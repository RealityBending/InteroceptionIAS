...
p <- data |>
  mutate(sig = ifelse(p < .01, "p < .01", ifelse(p < .001, "p < .001", "N.S.")),
         ...
         Category = fct_relevel(
           Category, "General", "Interoception", "Mood", "Psychopathology"),
         Component = fct_relevel(Component, "Personality", "Demographic", "Interoception", "MAIA", "Anxiety", "Depression", "Schizotypic", "Autistic", "Maladaptive")) |> 
  group_by(Component) |> 
