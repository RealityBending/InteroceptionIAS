...
data <- rbind(
  ...
  pool_coef(with = "PHQ9_Sum", component="Mood", name = "Depression (PHQ-9)"), 
...
data <- rbind(
  ...
  make_rez(with = "STAI5_General", component="Mood", name = "Anxiety (STAI-5)"),
  make_rez(with = "GAD7_Sum", component="Mood", name = "Anxiety (GAD-7)")
)
```
