...
data <- rbind(data, pool_coef(with = "ICQ", component="ICQ", name = "ICQ", unequalrange=TRUE))
```
...
data <- rbind(
  data,
  pool_coef(with = "PHQ2_Sum", component="Mood", name = "Depression (PHQ-2)"),
  ...
  pool_coef(with = "PHQ4_Depression", component="Mood", name = "Depression (PHQ-2)"),
...
data <- rbind(
  data,
  pool_coef(with = "GAD2_Sum", component="Mood", name = "Anxiety (GAD-2)"), 
  pool_coef(with = "STAIT_Sum", component="Mood", name = "Anxiety (STAI-T)",unequalrange=TRUE), 
  pool_coef(with = "PHQ4_Anxiety", component="Mood", name = "Anxiety (PHQ-4)"),
  pool_coef(with = "STAI5_General", component="Mood", name = "Anxiety (STAI-5)"),
...
data <- rbind(
  data,
  pool_coef(with = "NEO_FFI_SUMSCORE", component = "Personality", name = "Neuroticism"),
  pool_coef(with = "BFI_AGREEABLENESS", component="Personality", name = "Agreeableness"),
  pool_coef(with = "BFI_CONSCIENTIOUSNESS", component="Personality", name = "Conscientiousness"), 
  pool_coef(with = "BFI_NEUROTICISM", component="Personality", name = "Neuroticism"),
  pool_coef(with = "BFI_OPENNESS", component="Personality", name = "Openness"),
  pool_coef(with = "BFI_EXTROVERSION", component="Personality", name = "Extraversion"),
  pool_coef(with = "IPIP6_Agreeableness", component="Personality", name = "Agreeableness"),
  pool_coef(with = "IPIP6_Conscientiousness", component="Personality", name = "Conscientiousness"), 
  pool_coef(with = "IPIP6_Neuroticism", component="Personality", name = "Neuroticism"),
  pool_coef(with = "IPIP6_Openness", component="Personality", name = "Openness"),
  pool_coef(with = "IPIP6_Extraversion", component="Personality", name = "Extraversion"), 
  pool_coef(with = "IPIP6_HonestyHumility", component="Personality", name = "Honesty-Humility")
)
```
...
data <- rbind(data, pool_coef(with = "PI_Alive", component="World Beliefs", name = "Alive"))
