...
# rez_others <- rbind(
#   make_cor(df2, vars_intero, with = "ICQ", component="Other") |>
#     mutate(var_Correlate = "Interoceptive Confusion (ICQ)")
# )
# 
# display_sig(rez_others)
```
...
p <- data |>
  ...
  geom_linerange(aes(color=dir, alpha=sig, xmin=0, xmax=r, group=Sample), position = position_dodge2(width = 0.7), linewidth=2.5) +
