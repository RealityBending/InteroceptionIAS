...
data <- rbind(
  data,
  pool_coef(with = "Neuroticism", component = "Personality", name = "Neuroticism"),
  pool_coef(with = "Agreeableness", component="Personality", name = "Agreeableness"),
  pool_coef(with = "Conscientiousness", component="Personality", name = "Conscientiousness"), 
  pool_coef(with = "Openness", component="Personality", name = "Openness"),
  pool_coef(with = "Extraversion", component="Personality", name = "Extraversion"),
  pool_coef(with = "HonestyHumility", component="Personality", name = "Honesty-Humility")
)
```
