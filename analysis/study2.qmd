...
data <- rbind(
  data,
  # pool_coef(with = "BPQ_A", component="BPQ", name = "Body Awareness (BPQ)"),
  # pool_coef(with = "BPQ_R", component="BPQ", name = "Autonomic Reactivity (BPQ)"),
  pool_coef(with = "BPQ_BodyAwareness", component="BPQ", name = "Body Awareness (BPQ)"),
  pool_coef(with = "BPQ_AutonomicReactivity", component="BPQ", name = "Autonomic Reactivity (BPQ)")
  )
```
...
data <- rbind(
  ...
  make_rez(with = "PHQ4_Anxiety", component="Mood", name = "Anxiety (PHQ-4)"),
  # make_rez(with = "PHQ4_Anxiety", component="Mood", name = "Anxiety (STAI-5)"),
  make_rez(with = "GAD7_Sum", component="Mood", name = "Anxiety (GAD-9)")
)
```
